...
{
private:
	HRESULT InitModel(int xSize, int ySize);
...
public:
	Draw();
	~Draw();
	HRESULT Init(ID3D11DeviceContext* pContext, DWORD width, DWORD height, LPCWSTR* p_fileName, const int num, int xSize, int ySize);
