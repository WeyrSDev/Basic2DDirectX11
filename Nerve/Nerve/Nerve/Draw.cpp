...
// Direct3D初期化
HRESULT Draw::Init(ID3D11DeviceContext* pContext, DWORD width, DWORD height, LPCWSTR* p_fileName, const int num, int xSize, int ySize)
{
	//デバイスとコンテキストをコピー
...
HRESULT Draw::InitModel(int xSize, int ySize)
{
	// バーテックスバッファー作成
